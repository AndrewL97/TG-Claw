...
#define LIGHTING_HEIGHT         2 // height off the ground of light sources on the pseudo-z-axis, you should probably leave this alone
...
#define LIGHTING_PLANE_ALPHA_LOWLIGHT_VISION 215
